  ...
  <div class="basemsg">
    ...
    <el-form ref="baseMsg" :rules="rules" :model="baseMsg" status-icon label-width="80px">
      <el-form-item label="姓名" prop="name">
        <el-input clearable v-model.trim="baseMsg.name" placeholder="请输入姓名"></el-input>
      </el-form-item>
      <el-form-item label="电话" prop="phone">
        <el-input v-model.trim="baseMsg.phone" placeholder="请输入手机号码"></el-input>
      </el-form-item>
      <el-form-item label="邮箱" prop="email">
        <el-input v-model="baseMsg.email" placeholder="请输入常用邮箱"></el-input>
      </el-form-item>
      <el-form-item label="地址" prop="address">
        <el-input v-model="baseMsg.address" placeholder="请输入个人地址"></el-input>
      </el-form-item>
      <el-form-item label="求职意志" prop="position">
        <el-input v-model="baseMsg.position" placeholder="请输入您的求职意向"></el-input>
      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    next() {
      ...
      this.flag === true ? this.$router.push('/skill') : this.$message.error('填写表单错误')
    },
